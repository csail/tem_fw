 ...
 * @author Victor
 *
 * The tag includes information that assists the TEM driver. This information
 * includes: the public endorsement key, endorsement certificate, and driver
 * procs.
 * 
 * Tag information does not need to be stored securely. We just store it on the
 * TEM for convenience.
 */
public class TEMTag {
	/** The firmware version posted in the tag. */
	public static final short FIRMWARE_VER = 0x010A;
	 ...
	 * 
	 * Called when the TEM is activated. After this method is called, the TEM tag
	 * is not yet set.
	 */	
